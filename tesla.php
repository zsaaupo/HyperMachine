...
<div>
	<img src="ssc-tuatara.jpg">
</div>
<div>
	<h1 class="title">SSC Tuatara</h1>
</div>
<div class="cover01">
	
	<pre class="text01">Speed : 275 mph</pre>
	<pre class="text02">Engine : 6.8L quad-cam, twin-turbo V8</pre>
	<pre class="text03">Horse power : 789 hp</pre>
	<pre class="text04">RPM : 9000</pre>
