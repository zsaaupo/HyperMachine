...
<div>
	<img src="pagani-huayra-roadster-bc.jpg">
</div>
<div>
	<h1 class="title">Pagani Huayra Roadster BC</h1>
</div>
<div class="cover01">
	
	<pre class="text01">Speed : 174 mph</pre>
	<pre class="text02">Engine : 6.0 L twin-turbocharged V12</pre>
	<pre class="text03">Horse power : 789 hp</pre>
	<pre class="text04">RPM : 4500</pre>
	<pre class="text05">weight : 1218 kg</pre>
