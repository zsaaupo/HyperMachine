...
<div>
	<h1 class="title">Devel 16</h1>
</div>
<div class="cover01">
	
	<pre class="text01">Speed : 347 mph</pre>
	<pre class="text02">Engine : 12.3 l quad turbo v16</pre>
	<pre class="text03">Horse power : 5007 hp</pre>
	<pre class="text04">RPM : 6900</pre>
	<pre class="text05">weight : 2300 kg</pre>
